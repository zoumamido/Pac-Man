...
void specFunc(unsigned char buttons, int x, int y){
switch (buttons){
case '1': PlaySound("breakout.wav.wav", NULL, SND_FILENAME | SND_ASYNC | SND_LOOP);
    glutInitWindowPosition(100,100);
glutInitWindowSize(600,600);
...
glutMainLoop();
       ;break;
case '2':PlaySound("breakout.wav.wav", NULL, SND_FILENAME | SND_ASYNC | SND_LOOP);
    glutInitWindowPosition(100,100);
glutInitWindowSize(600,600);
glutCreateWindow("Pacman level 2");
gluOrtho2D(0,600,0,600);
...
glutMainLoop();
       ;break;
case '3':PlaySound("breakout.wav.wav", NULL, SND_FILENAME | SND_ASYNC | SND_LOOP);
    glutInitWindowPosition(100,100);
glutInitWindowSize(600,600);
glutCreateWindow("Pacman Level 3");
gluOrtho2D(0,600,0,600);
...
PlaySound("breakout.wav.wav", NULL, SND_FILENAME | SND_ASYNC | SND_LOOP);
glutInitWindowPosition(100,100);
glutInitWindowSize(600,600);
...
int main(){
 PlaySound("Pacman-sound.wav", NULL, SND_FILENAME | SND_ASYNC | SND_LOOP);
glutInitWindowPosition(100,100);
glutInitWindowSize(600,600);
